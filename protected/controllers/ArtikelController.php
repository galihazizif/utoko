...
class ArtikelController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Artikel']))
		{
			...
			$model->artikel_tanggal = date('Y-m-d H:i:s');
			if($model->save())
				$this->redirect(array('view','id'=>$model->artikel_id));
		}
	...
	public function actionDetail(){
		...
		if($model == null)
			throw new CHttpException(404,"Artikel tidak ditemukan");
	...
	public function actionDelete($id)
	{
		...
		Yii::app()->user->setFlash('notifSuccess','Item telah dihapus');
