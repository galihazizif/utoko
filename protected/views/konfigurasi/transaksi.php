...
?>
<div class="well">
<h4>Daftar pemesanan produk yang dilakukan oleh pengunjung</h4>
<form>
...
<table class="table table-condensed table-striped table-hover table-bordered">
	...
	<?php
		switch ($row->trans_status) {
			case Transaksi::STATUS_ADDED:
				$rowClass = 'danger';
				break;
			case Transaksi::STATUS_PAYMENT_CONFIRMED:
				$rowClass = 'success';
				break;
	...
	<tr class="<?php echo $rowClass;?>">
		...
		<td><?php echo $row->transUser->user_nama;?></td>
		<td><?php echo $row->transUser->user_telepon;?></td>
		<td><?php echo TextHelper::tanggal($row->trans_tanggal);?></td>
		<td><?php echo $row->statusReadable();?></td>
		<td><a class="btn btn-bs btn-default btn-xs tombol" href="<?php echo $this->createUrl('konfigurasi/transaksidetail',array('kodetrans'=>$row->trans_kodetrans));?>">Rincian</a></td>
	</tr>
	<?php endforeach;?>
</table>
</small>
