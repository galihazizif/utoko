...
?>
<div class="well">
<h4>Konfirmasi Pengiriman Barang</h4>
...
<table class="table table-condensed table-striped table-hover table-bordered">
	...
	<tr>
	<form id="form-approve" method="POST" action="<?php echo $this->createUrl('konfigurasi/konfirmasipengiriman',array('kodetrans'=>$row->trans_kodetrans));?>">
		<td class="align-right" colspan="3">Keterangan (Nomor Resi, dsb)</td>
		<td class="align-right"><textarea name="Transaksi[trans_keterangan]" id="trans_keterangan" class="form-control"  placeholder="misal: JNE 12345678910112"></textarea></td>
	</form>
	</tr>
</table>
<div class="row">
...
<div class="col-md-4">
	<button id="btn-approve" type="button" href="<?php echo $this->createUrl('konfigurasi/konfirmasipengiriman'); ?>" class="btn btn-primary btn-lg btn-block">Konfirmasi Pengiriman</button></p>
</div>
</div>
</div>
