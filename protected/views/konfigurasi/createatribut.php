...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<h4>Tambah <?php echo $kategori->kata_nama;?></h4>

	<div class="form-group">
		<?php echo $form->labelEx($model,'artribut_deskripsi'); ?>
		<?php echo $form->textField($model,'artribut_deskripsi',array('class'=>'form-control','rows'=>9)); ?>
		<?php echo $form->error($model,'artribut_deskripsi'); ?>
	</div>
